...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@yoga-master.l4ypde0.mongodb.net/?retryWrites=true&w=majority&appName=yoga-master`;
...
async function run() {
  try {
    ...
    app.get("/classes/:email",verifyJWT, verifyInstructor, async (req, res) => {
      const email = req.params.email;
      const query = { insructorEmail: email };
    ...
    //update classes status and region
    app.patch("/change-status/:id", verifyJWT, verifyInstructor,async (req, res) => {
      const id = req.params.id;
    ...
    app.put("/update-class/:id", verifyJWT, verifyInstructor,async (req, res) => {
      ...
      const updateDoc = {
        $set: {
          name: updateClas.name,
          description: updateClas.description,
          price: updateClas.price,
          availableSeats: updateClas.availableSeats,
          videoLink: updateClas.videoLink,
          status: "pending",
        },
      };
      const result = await classesCollection.updateOne(
